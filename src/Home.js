...
export default function Home() {
    ...
    return (
        <div className="contentLayer relative flex flex-col justify-center items-center w-full">
            ...
            {/* first grid element */}
            <div class="flex biggy flex-col md:flex-row  md:max-w-lg">

                {/* this is the text */}
                <div class="texty flex flex-col  opacity-0 justify-center ">
                    <h1 class="text-gray-100 text-4xl md:text-7xl font-extrabold" >Emira Shano</h1>
